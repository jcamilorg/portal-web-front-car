...
import HrCAR from "../../components/HrCAR";
  ...
  return (
    <ContainerSearchBox>
      ...
      <div className="container-filters">
        ...
        <ButtonCAR className="filtrar" onClick={handleSearch} href={null}>
          Filtrar
        </ButtonCAR>
      </div>
    </ContainerSearchBox>
...
export default function Noticias() {
  ...
  if (noticiasItems.length <= 0) {
    noticiasItems = [
      <h3 key={1} className="text-center pt-5 mt-5">
  ...
  const handleSearch = () => {
    let word = (document.querySelector("#word") as HTMLInputElement).value;
  ...
  return (
    ...
    >
      <div className="row justify-content-center">
        ...
        <HrCAR type2={null} className={null} style={null} />
        <ContainerPaginate>
          <ReactPaginate
