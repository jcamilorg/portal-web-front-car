...
import { useDirectoryApi } from "../../components/getDataFromApi";
...
const DireccionAreaInfo2 = ({ sede }: any) => {
  const extensions = sede.extensions.map((ext: any) => (
    <>
...
const RowInfo2 = ({ title, cities, number, location, mail, schedule }: any) => (
  <>
...
const TableDirectories2 = ({ directory }: any) => {
  console.log(directory);
  const items = directory.map((item: any) => {
    let result =
...
// const CardInfo = ({ title, cities }: any) => (
